  ...
  class Plugin::Nexpose < Msf::Plugin
    class NexposeCommandDispatcher
      ...
      def nexpose_verify_db
        unless framework.db && framework.db.usable && framework.db.active
      ...
      def nexpose_verify
        return false unless nexpose_verify_db
      ...
      def cmd_nexpose_connect(*args)
        return unless nexpose_verify_db

        unless args[0]
          if ::File.readable?(Nexpose_yaml.to_s)
