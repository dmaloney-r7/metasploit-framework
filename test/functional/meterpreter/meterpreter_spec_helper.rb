  ...
  module MeterpreterSpecHelper
    def self.included(base)
      base.class_eval do
        ...
        def hlp_run_command_check_output(name, command, _success_strings = [], fail_strings = [], fail_exception_strings = [])
          fail_strings |= generic_failure_strings
          fail_exception_strings |= generic_failure_exception_strings
