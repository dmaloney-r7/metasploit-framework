...
class MetasploitModule < Msf::Auxiliary
  ...
  def html_get_hash(arg = {})
    ...
    unless (@previous_lm_hash == lm_hash) && (@previous_ntlm_hash == nt_hash)
      ...
      opts_report[:lm_cli_challenge] = lm_cli_challenge if lm_cli_challenge
      opts_report[:nt_cli_challenge] = nt_cli_challenge if nt_cli_challenge
  ...
  def report_hash(ip, user, type_hash, hash)
    ...
    credential_data[:jtr_format] = type_hash unless type_hash.nil?
