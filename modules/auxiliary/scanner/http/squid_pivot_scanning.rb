...
class MetasploitModule < Msf::Auxiliary
  ...
  def run_host(_target_host)
    begin
      ...
      raise Msf::OptionValidateError, ['PORTS'] if portlist.empty?
      ...
      iplist.each do |target|
        ...
        portlist.each do |port|
          ...
          next unless res && res.body

          if (res.code == 200) || res.body =~ /Zero/ || (res.code == 404) || (res.code == 401)
          ...
          if res.body =~ /Connection refused/ || res.body =~ /service not listening/
