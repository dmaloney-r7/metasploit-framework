      ...
      users.each do |user_pass|
        ...
        if res && (res.code == 200)
          ...
          doc.elements.each('USER_PASSWORD_LIMITS/ROW') do |e|
            ...
            if e.elements['RESOURCE_NAME'].get_text == 'FAILED_LOGIN_ATTEMPTS'
              fla = e.elements['LIMIT'].get_text
            elsif e.elements['RESOURCE_NAME'].get_text == 'PASSWORD_LIFE_TIME'
              plit = e.elements['LIMIT'].get_text
            elsif e.elements['RESOURCE_NAME'].get_text == 'PASSWORD_REUSE_TIME'
              prt = e.elements['LIMIT'].get_text
            elsif e.elements['RESOURCE_NAME'].get_text == 'PASSWORD_REUSE_MAX'
              prm = e.elements['LIMIT'].get_text
            elsif e.elements['RESOURCE_NAME'].get_text == 'PASSWORD_LOCK_TIME'
              plot = e.elements['LIMIT'].get_text
            elsif e.elements['RESOURCE_NAME'].get_text == 'PASSWORD_GRACE_TIME'
