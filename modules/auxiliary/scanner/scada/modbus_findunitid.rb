...
class MetasploitModule < Msf::Auxiliary
  ...
  def run
    ...
    if datastore['UNIT_ID_FROM'] > datastore['UNIT_ID_TO']
    ...
    datastore['UNIT_ID_FROM'].upto(datastore['UNIT_ID_TO']) do |counter|
      ...
      data = noll + noll + noll + noll if data.nil?
