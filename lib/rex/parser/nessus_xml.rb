  ...
  module Parser
    class NessusXMLStreamParser
      ...
      def tag_start(name, attributes)
        case name
        when "tag"
          @state = :is_mac if attributes['name'] == "mac-address"
          @state = :is_fqdn if attributes['name'] == "host-fqdn"
          @state = :is_ip if attributes['name'] == "ip-addr"
          @state = :is_ip if attributes['name'] == "host-ip"
          @state = :is_os if attributes['name'] == "operating-system"
        when "ReportHost"
