  ...
  module Parser
    ...
    load_nokogiri && class BurpSessionDocument < Nokogiri::XML::SAX::Document
                       ...
                       def collect_path_and_query
                         ...
                         real_path = if path =~ /https?:[\x5c\x2f][\x5c\x2f]+[^\x5c\x2f][^\x5c\x2f]+([^?]+)/n
                                       "/#{Regexp.last_match(1)}"
                                     else
                                       path
                                     end
                       ...
                       def report_web_host_info
                         ...
                         return unless @state[:uri].is_a? URI::HTTP
                       ...
                       def report_web_site(&block)
                         ...
                         web_site_info[:ssl]  = @state[:uri].is_a? URI::HTTPS
