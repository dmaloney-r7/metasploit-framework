  ...
  class ServiceManager < Hash
    ...
    def stop_service(inst)
      ...
      if inst
        ...
        each_pair do |cals, cinst|
          delete(cals) if inst == cinst
        end
