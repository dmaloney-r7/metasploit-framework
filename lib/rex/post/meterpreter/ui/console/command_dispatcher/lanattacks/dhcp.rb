      ...
      module Ui
        ...
        class Console::CommandDispatcher::Lanattacks::Dhcp
          ...
          def cmd_dhcp_start(*args)
            @@dhcp_start_opts.parse(args) do |opt, _idx, _val|
              case opt
              when '-h'
          ...
          def cmd_dhcp_stop(*args)
            @@dhcp_stop_opts.parse(args) do |opt, _idx, _val|
              case opt
              when '-h'
          ...
          def cmd_dhcp_reset(*args)
            @@dhcp_reset_opts.parse(args) do |opt, _idx, _val|
              case opt
              when '-h'
          ...
          def cmd_dhcp_set_option(*args)
            @@dhcp_set_option_opts.parse(args) do |opt, _idx, _val|
              case opt
              when '-h'
            ...
            unless @@dhcp_set_option_valid_options.include? name
          ...
          def cmd_dhcp_log(*args)
            @@dhcp_log_opts.parse(args) do |opt, _idx, _val|
              case opt
              when '-h'
