      ...
      module Ui
        ...
        class Console::CommandDispatcher::Incognito
          ...
          def cmd_list_tokens(*args)
            ...
            @@list_tokens_opts.parse(args) do |opt, _idx, _val|
              case opt
              when "-u"
                token_order = 0
              when "-g"
            ...
            tokens['delegation'].each_line do |string|
              print(string)
            end
            ...
            tokens['impersonation'].each_line do |string|
              print(string)
            end
          ...
          def cmd_impersonate_token(*args)
            ...
            system_privilege_check
            username = args[0]
            client.incognito.incognito_impersonate_token(username).each_line do |string|
              print(string)
            end
          ...
          def cmd_add_user(*args)
            ...
            @@add_user_opts.parse(args) do |opt, _idx, val|
              case opt
              when "-h"
                host = val
              end
            ...
            client.incognito.incognito_add_user(host, username, password).each_line do |string|
              print(string)
            end
          ...
          def cmd_add_localgroup_user(*args)
            ...
            @@add_localgroup_user_opts.parse(args) do |opt, _idx, val|
              case opt
              when "-h"
                host = val
              end
            ...
            client.incognito.incognito_add_localgroup_user(host, groupname, username).each_line do |string|
              print(string)
            end
          ...
          def cmd_add_group_user(*args)
            ...
            @@add_group_user_opts.parse(args) do |opt, _idx, val|
              case opt
              when "-h"
                host = val
              end
            ...
            client.incognito.incognito_add_group_user(host, groupname, username).each_line do |string|
              print(string)
            end
