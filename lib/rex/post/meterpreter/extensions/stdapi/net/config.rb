          ...
          module Net
            ...
            class Config
              ...
              def get_interfaces
                ...
                response.each(TLV_TYPE_NETWORK_INTERFACE) do |iface|
                  addrs = []
                  netmasks = []
                  scopes = []
                  while (a = iface.get_tlv_value(TLV_TYPE_IP, addrs.length))
                    ...
                    if n.nil?
                      ...
                      n = Rex::Socket.bit2netmask(n, !!(a.length == 16)) if n
                    else
              ...
              def get_netstat
                ...
                response.each(TLV_TYPE_NETSTAT_ENTRY) do |connection|
                  netstat << Netstat.new(
              ...
              def get_arp_table
                ...
                response.each(TLV_TYPE_ARP_ENTRY) do |arp|
                  arps << Arp.new(
