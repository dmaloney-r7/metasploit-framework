            ...
            module ProcessSubsystem
              ...
              class Memory
                ...
                def allocate(length, protection = nil, base = nil)
                  ...
                  protection = if protection.nil?
                                 PAGE_EXECUTE_READWRITE
                               else
                                 gen_prot_to_specific(protection)
                               end

                  # If the preferred base is non-nil, set the reserve flag
                  allocation_type |= MEM_RESERVE unless base.nil?

                  _allocate(base, length, allocation_type, protection)
                end
                ...
                def _allocate(base, length, allocation_type, protection)
                  ...
                  request.add_tlv(TLV_TYPE_BASE_ADDRESS, base) unless base.nil?
                  ...
                  response.get_tlv_value(TLV_TYPE_BASE_ADDRESS)
                end
                ...
                def read(base, length)
                  ...
                  response.get_tlv_value(TLV_TYPE_PROCESS_MEMORY)
                end
                ...
                def write(base, data)
                  ...
                  response.get_tlv_value(TLV_TYPE_LENGTH)
                end
                ...
                def protect(base, length = nil, protection = nil)
                  ...
                  specific_prot_to_gen(response.get_tlv_value(TLV_TYPE_PROTECTION))
                end
                ...
                def gen_prot_to_specific(prot)
                  return PAGE_READ if prot.nil?

                  @@page_protection_map[prot]
                end
                ...
                def specific_prot_to_gen(prot)
                  return PAGE_READONLY if prot.nil?

                  @@page_protection_map.invert[prot]
                end
