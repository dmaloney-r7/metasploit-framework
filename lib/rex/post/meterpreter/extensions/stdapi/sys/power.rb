        ...
        module Stdapi
          module Sys
            ...
            class Power
              ...
              #
              def self._exitwindows(flags, reason = 0, force = 0) # :nodoc:
              ...
              #
              def self.reboot(force = 0, reason = 0)
                _exitwindows(EWX_REBOOT, reason, force)
              end

              #
              # Shuts down the remote machine.
              #
              def self.shutdown(force = 0, reason = 0)
                _exitwindows(EWX_POWEROFF, reason, force)
              end
              end
