      ...
      module Extensions
        module Android
          ...
          class Android < Extension
            ...
            def collect_actions
              @@collect_action_list ||= COLLECT_ACTIONS.keys
            end

            def collect_types
              @@collect_type_list ||= COLLECT_TYPES.keys
            end
              ...
              when COLLECT_TYPE_WIFI
                ...
                response.each(TLV_TYPE_COLLECT_RESULT_GROUP) do |g|
                  ...
                  g.each(TLV_TYPE_COLLECT_RESULT_WIFI) do |w|
                    ...
                    next unless !records.include?(key) || records[key][0] < timestamp
