    ...
    module Win32
      ...
      module Kernel
        ...
        def self.construct(opts = {})
          ...
          if opts['Recovery'] && Kernel::Recovery.respond_to?(opts['Recovery'], true)
          ...
          # Generate the stager
          if opts['Stager'] && Kernel::Stager.respond_to?(opts['Stager'], true)
            payload = Kernel::Stager.send(opts['Stager'], opts)
          # Or, generate the migrator
          elsif opts['Migrator'] && Kernel::Migration.respond_to?(opts['Migrator'], true)
