    ...
    class Client
      ...
      def openscmanagerw(rhost, access = SC_MANAGER_ALL_ACCESS)
        ...
        begin
          ...
          if response
            ...
            scm_handle = response[0, 20] if scm_status == ERROR_SUCCESS
          end
      ...
      def createservicew(scm_handle, service_name, display_name, binary_path, opts)
        ...
        begin
          ...
          if response
            ...
            svc_handle = response[4, 20] if svc_status == ERROR_SUCCESS
          end
        rescue Rex::Proto::DCERPC::Exceptions::Fault => e
          print_error("Error creating service: #{e}")
        end

        [svc_handle, svc_status]
      end
      ...
      def closehandle(handle)
        ...
        begin
          ...
          svc_status = error_code(response[20, 4]) if response
        rescue Rex::Proto::DCERPC::Exceptions::Fault => e
      ...
      def openservicew(scm_handle, service_name, access = SERVICE_ALL_ACCESS)
        ...
        begin
          ...
          if response
            ...
            svc_handle = response[0, 20] if svc_status == ERROR_SUCCESS
          end
        rescue Rex::Proto::DCERPC::Exceptions::Fault => e
      ...
      def startservice(svc_handle, magic1 = 0, magic2 = 0)
        ...
        begin
          ...
          svc_status = error_code(response) if response
        rescue Rex::Proto::DCERPC::Exceptions::Fault => e
      ...
      def controlservice(svc_handle, operation)
        ...
        begin
          ...
          svc_status = error_code(response[28, 4]) if response
        rescue Rex::Proto::DCERPC::Exceptions::Fault => e
