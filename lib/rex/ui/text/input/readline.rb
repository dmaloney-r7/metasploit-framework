      ...
      begin
        ...
        class Input::Readline < Rex::Ui::Text::Input
          ...
          def initialize(tab_complete_proc = nil)
            require 'readline' unless Object.const_defined?('Readline')
          ...
          def pgets
            ...
            begin
              ...
              ::Readline::HISTORY.pop if line && line.empty?
            ensure
          ...
          def readline_with_output(prompt, add_history = false)
            ...
            reset_sequence = "" if /mingw/ =~ RUBY_PLATFORM
            if defined? RbReadline
              ...
              RbReadline.add_history(line) if add_history && line
