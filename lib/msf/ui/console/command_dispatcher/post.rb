    ...
    module Console
      module CommandDispatcher
        ...
        class Post
          ...
          #
          def commands
            super.update("run" => "Launches the post exploitation module",
                         "rerun" => "Reloads and launches the module",
                         "exploit"  => "This is an alias for the run command",
                         "rexploit" => "This is an alias for the rerun command").merge((mod ? mod.post_commands : {}))
          end
          ...
          def method_missing(meth, *args)
            if mod && mod.respond_to?(meth.to_s)
          ...
          def cmd_run(*args)
            ...
            @@post_opts.parse(args) do |opt, _idx, val|
              case opt
              when '-j'
                jobify = true
              when '-o'
