    ...
    module Console
      module CommandDispatcher
        ...
        class Auxiliary
          ...
          #
          def commands
            super.update("run" => "Launches the auxiliary module",
                         "rerun" => "Reloads and launches the auxiliary module",
                         "exploit" => "This is an alias for the run command",
                         "rexploit" => "This is an alias for the rerun command",
                         "reload"   => "Reloads the auxiliary module").merge((mod ? mod.auxiliary_commands : {}))
          end
          ...
          def cmd_run(*args)
            ...
            @@auxiliary_opts.parse(args) do |opt, _idx, val|
              case opt
              when '-j'
                jobify = true
              when '-o'
            ...
            jobify = true if mod.passive || mod.passive_action?(action)
