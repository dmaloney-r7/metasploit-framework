  ...
  module Ui
    module Web
      module Comm
        ...
        def self.create_channel(client, _request)
        ...
        def self.write_channel(_client, request)
          channel_id = request.qstring['channel_id']
          data       = request.qstring['data']
          channel    = @channels[channel_id]

          channel.write_input(data) if channel.nil? == false
        end
        ...
        def self.read_channels(client, request)
          ...
          channels = [channels] if channels.is_a?(Array) == false
