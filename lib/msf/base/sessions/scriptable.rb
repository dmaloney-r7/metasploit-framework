    ...
    module ClassMethods
      ...
      def find_script_path(script)
        ...
        check_paths =
          [
            script,
            ::File.join(script_base, script.to_s),
            ::File.join(script_base, "#{script}.rb"),
            ::File.join(user_script_base, script.to_s),
      ...
      def script_base
        ::File.join(Msf::Config.script_directory, type)
      end

      def user_script_base
        ::File.join(Msf::Config.user_script_directory, type)
      end
    end
      ...
      if mod
        ...
        if mod.type == "post"
          ...
          if mod.exploit_type == "local"
            ...
            original_exploit_datastore = exploit.datastore || {}
