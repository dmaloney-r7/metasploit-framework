  ...
  module Sessions
    module MeterpreterOptions
      ...
      def on_session(session)
        ...
        framework.sessions.schedule proc {
          ...
          if valid
            ...
            if datastore['AutoLoadStdapi']
              ...
              session.load_session_info if datastore['AutoSystemInfo']
            ...
            if session.platform == 'android'
              session.load_android if datastore['AutoLoadAndroid']
            end

            [ 'InitialAutoRunScript', 'AutoRunScript' ].each do |key|
              next if datastore[key].empty?
