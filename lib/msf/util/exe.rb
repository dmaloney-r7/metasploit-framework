  ...
  module Util
    ...
    class EXE
      ...
      def self.set_template_default(opts, exe = nil, path = nil)
        ...
        if opts[:fallback]
          ...
          if File.file?(default_template)
            ...
            opts[:fellback] = default_template
      ...
      def self.to_win32pe(framework, code, opts = {})
        ...
        if opts[:inject]
          injector = Msf::Exe::SegmentInjector.new(payload: code,
        ...
        if text.size < p_length
          appender = Msf::Exe::SegmentAppender.new(payload: code,
                                                   template: opts[:template],
                                                   arch: :x86)
        ...
        if payload.length + 256 > block[1]
          raise "The largest block in .text does not have enough contiguous space (need:#{payload.length + 256} found:#{block[1]})"
        end
        ...
        exe[exe.index([cks].pack('V')), 4] = [0].pack("V") unless cks == 0
      ...
      def self.to_winpe_only(_framework, code, opts = {}, arch = ARCH_X86)
        # Allow the user to specify their own EXE template
        ...
        sections_header.each do |sec|
          ...
          next unless (virtualAddress...virtualAddress + sizeOfRawData).cover?(addressOfEntryPoint)
      ...
      def self.to_win32pe_old(framework, code, opts = {})
        ...
        bo = pe.index('PAYLOAD:')
        raise "Invalid Win32 PE OLD EXE template: missing \"PAYLOAD:\" tag" unless bo
      ...
      # @param opts       [Hash]
      # @return           [String]
      def self.to_win32pe_exe_sub(_framework, code, opts = {})
      ...
      # @param opts       [Hash]
      # @return           [String]
      def self.to_win64pe(_framework, code, opts = {})
        # Allow the user to specify their own EXE template
      ...
      def self.to_win32pe_service(_framework, code, opts = {})
        ...
        if opts[:sub_method]
          ...
          Msf::Exe::SegmentAppender.new(payload: code_service + code,
                                        template: opts[:template],
                                        arch: :x86).generate_pe
        end
      end
      ...
      # @return           [String]
      def self.to_win64pe_service(_framework, code, opts = {})
        # Allow the user to specify their own service EXE template
      ...
      # @option           [String] :inject
      # @return           [String]
      def self.to_win64pe_dll(_framework, code, opts = {})
        # Allow the user to specify their own DLL template
      ...
      # @return [String]
      def self.to_exe_msi(_framework, exe, opts = {})
        opts[:msi_template] ||= if opts[:uac]
      ...
      def self.replace_msi_buffer(pe, opts)
        ...
        template = if opts[:msi_template].include?(File::SEPARATOR)
                     opts[:msi_template]
                   else
                     File.join(opts[:msi_template_path], opts[:msi_template])
                   end
      ...
      # @return           [String]
      def self.to_osx_arm_macho(_framework, code, opts = {})
      ...
      # @option           [String] :template
      # @return           [String]
      def self.to_osx_ppc_macho(_framework, code, opts = {})
        # Allow the user to specify their own template
      ...
      # @option           [String] :template
      # @return           [String]
      def self.to_osx_x86_macho(_framework, code, opts = {})
        # Allow the user to specify their own template
      ...
      # @option           [String] :template
      # @return           [String]
      def self.to_osx_x64_macho(_framework, code, opts = {})
      ...
      # @return           [String]
      def self.to_exe_elf(_framework, opts, template, code, big_endian = false)
        # Allow the user to specify their own template
      ...
      def self.to_vba(_framework, code, _opts = {})
        hash_sub = {}
      ...
      # @param code       [String]
      #
      def self.to_powershell_vba(_framework, arch, code)
      ...
      # @param exes [String]
      # @param opts [Hash]    Unused
      def self.to_exe_asp(exes = '', _opts = {})
        hash_sub = {}
      ...
      # @param  exes [String]
      # @option opts [Hash]
      def self.to_exe_aspx(exes = '', _opts = {})
        hash_sub = {}
      ...
      def self.to_mem_aspx(_framework, code, _exeopts = {})
        # Intialize rig and value names
        rig = Rex::RandomIdentifier::Generator.new
      ...
      def self.to_win32pe_psh_net(_framework, code, _opts = {})
        Rex::Powershell::Payload.to_win32pe_psh_net(Rex::Powershell::Templates::TEMPLATE_DIR, code)
      end

      def self.to_win32pe_psh(_framework, code, _opts = {})
      ...
      #
      def self.to_win32pe_psh_reflection(_framework, code, _opts = {})
        Rex::Powershell::Payload.to_win32pe_psh_reflection(Rex::Powershell::Templates::TEMPLATE_DIR, code)
      end

      def self.to_powershell_command(_framework, arch, code)
        template_path = Rex::Powershell::Templates::TEMPLATE_DIR
      ...
      def self.to_powershell_hta(_framework, arch, code)
        template_path = Rex::Powershell::Templates::TEMPLATE_DIR
