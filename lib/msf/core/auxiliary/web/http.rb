...
module Msf
  class Auxiliary::Web::HTTP
    ...
    def initialize(opts = {})
      ...
      @headers.delete('Cookie') unless @headers['Cookie']
    ...
    def connect
      ...
      c.set_config('vhost' => opts[:target].vhost,
    ...
    def if_not_custom_404(path, body)
      custom_404?(path, body) { |b| yield unless b }
    end
    ...
    def _request(url, opts = {})
      ...
      unless (vars_get = Auxiliary::Web::Form.query_to_params(url.query)).empty?
