...
module Msf
  ...
  module Auxiliary::UDPScanner
    ...
    def scanner_send(data, ip, port)
      ...
      scanner_recv(0.1) if @udp_send_count % datastore['ScannerRecvInterval'] == 0
    ...
    def scanner_recv(timeout = 0.1)
      ...
      while (res = @udp_sock.recvfrom(65535, timeout))
        ...
        break if queue.length > datastore['ScannerRecvQueueLimit']
      end
