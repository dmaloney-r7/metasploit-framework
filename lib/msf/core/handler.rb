...
module Msf
  ...
  module Handler
    ...
    def wait_for_session(t = wfs_delay)
      ...
      session = session_waiter_event.wait if pending_connections > 0
    ...
    def register_session(session)
      ...
      framework.events.on_exploit_success(assoc_exploit, session) if assoc_exploit
