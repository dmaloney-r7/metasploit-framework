    ...
    module ReverseTcpDouble
      ...
      def start_handler
        self.listener_thread = framework.threads.spawn("ReverseTcpDoubleHandlerListener", false) {
          ...
          loop do
            ...
            conn_threads << framework.threads.spawn("ReverseTcpDoubleHandlerSession", false, client_a, client_b) do |client_a_copy, client_b_copy|
              begin
      ...
      class TcpReverseDoubleSessionChannel
        ...
        def initialize(framework, inp, out)
          ...
          lsock.extend(TcpReverseDoubleChannelExt)
        ...
        def monitor_shell_stdout
          ...
          @monitor_thread = @framework.threads.spawn("ReverseTcpDoubleHandlerMonitor", false) do
            begin
              loop do
