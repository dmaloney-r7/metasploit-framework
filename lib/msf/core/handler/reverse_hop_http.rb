  ...
  module Handler
    ...
    module ReverseHopHttp
      ...
      def start_handler
        ...
        if ReverseHopHttp.hop_handlers.key?(full_uri)
        ...
        self.monitor_thread = Rex::ThreadFactory.spawn('ReverseHopHTTP', false, uri,
          ...
          until hop_http.refs < 1 && hop_http.handlers.empty?
            sleep delay
            delay += 1 if delay < 10 # slow down if we're not getting anything
