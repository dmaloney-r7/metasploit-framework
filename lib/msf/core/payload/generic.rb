...
module Msf
  ...
  module Payload::Generic
    ...
    def find_actual_payload
      return unless actual_payload.nil?
      ...
      if actual_payload.nil?
        ...
        actual_payload.share_datastore(datastore)

        # Set the associated exploit for the payload.
        actual_payload.assoc_exploit  = assoc_exploit
        ...
        # work properly)
        actual_payload.parent_payload = self

        # Set the cached user_input/user_output
        actual_payload.user_input  = user_input
        actual_payload.user_output = user_output
      end
    end
  end
end
