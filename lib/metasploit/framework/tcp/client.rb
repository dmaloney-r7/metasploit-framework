  ...
  module Framework
    module Tcp
      module EvasiveTCP
        ...
        def write(buf, opts = {})
          return super(buf, opts) unless @evasive
          ...
          while idx < buf.length
            ...
            ::IO.select(nil, nil, nil, @_send_delay) if @_send_delay && idx > 0
      ...
      module Client
        ...
        def set_tcp_evasions(socket)
          return if (max_send_size.to_i == 0) && (send_delay.to_i == 0)
