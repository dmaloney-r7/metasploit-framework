...
module SNMP
  module BER #:nodoc:all
    ...
    def assert_no_remainder(remainder)
      raise ParseError, remainder.inspect if remainder && (remainder != "")
    end
    ...
    def decode_object_id(data)
      ...
      [decode_object_id_value(value), remainder]
    end
    ...
    def encode_tlv(tag, value)
      ...
      data = data << value unless value.empty?
      data
    end
    ...
    def encode_object_id(value)
      raise InvalidObjectId, value.to_s if value.empty?
