...
def log_folder_create(log_path = nil)
  ...
  logs = if log_path
           ::File.join(log_path, 'logs', "sound_recorder", host + filenameinfo)
         else
           ::File.join(Msf::Config.log_directory, "scripts", "sound_recorder", host + filenameinfo)
         end
...
log_folder = log_folder_create unless log_folder
